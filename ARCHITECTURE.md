...
3. **GitHub Pages deployment target** — `.github/workflows/deploy-trading-apps.yml` deploys chart-viewer to GitHub Pages. Not a GCP resource. (options-heatseeker was archived 2026-05-04 to `archive/old-apps/`; its replacement is the React platform's `/options` route on Cloud Run.)
