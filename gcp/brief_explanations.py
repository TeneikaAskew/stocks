...
_PLAYBOOK_PROMPT = (
    ...
    "PDH/PDL/PDC = Previous Day High/Low/Close (yesterday's session). "
    "PDO = Previous Day Open (yesterday's open). "
    "PWH/PWL/PWC/PWO = Previous Week High/Low/Close/Open. "
    "PMH/PML/PMC/PMO = Previous Month equivalents. "
