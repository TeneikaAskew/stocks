...
def main():
    ...
    if args.tickers:
        ...
        tickers = _earnings_calendar_tickers(args.earnings_window_days)
        log.info("Resolved %d tickers from earnings_calendar (±%dd)",
                 len(tickers), args.earnings_window_days)
