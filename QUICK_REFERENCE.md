...
1. Run backtest: `python scripts/run_backtest.py --ticker IWM --use-strat`
2. Run timeframe sweep: `python scripts/run_timeframe_sweep.py --ticker IWM --use-strat`
3. Review results in `data/backtest_results/`
4. Run analysis: `python iwm_analysis.py -months 2`
5. Load signals: `signals = pd.read_csv('data/historical_iwm_0824_0825_signals.csv')`
6. Test patterns using examples above
