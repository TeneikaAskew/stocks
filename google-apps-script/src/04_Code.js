...
function onOpen() {
  ...
  ui.createMenu('EarningsWhispers')
    ...
    .addSubMenu(ui.createMenu('📈 Data Management')
      ...
      .addSeparator()
      .addSubMenu(ui.createMenu('Column Management')
        .addItem('Add to Current Sheet', 'EW_addColumnsToCurrentSheet')
        .addItem('Add to All Sheets', 'EW_addTrackingColumnsToAll')
      )
    )
    
    // Calculations submenu
    .addSubMenu(ui.createMenu('🧮 Calculations')
      .addSubMenu(ui.createMenu('Technical Indicators')
        .addItem('Recalculate Selected', 'EW_recalculateIndicatorsForSelected')
        .addItem('Recalculate Sheet', 'EW_recalculateIndicatorsForSheet')
        .addItem('Check Missing', 'EW_checkMissingIndicators')
      )
      .addSeparator()
      .addSubMenu(ui.createMenu('Favorable/Unfavorable')
        .addItem('Calculate All Missing', 'EW_calculateMissingFavorables')
        .addItem('Calculate Selected', 'EW_calculateFavorablesForSelected')
        .addItem('Validate Against OHLC', 'EW_validateFavorablesAgainstOHLC')
      )
      .addSeparator()
    ...
    .addSubMenu(ui.createMenu('📋 Reports & Analysis')
      .addItem('Success Report', 'EW_generateSuccessReport')
      .addItem('Update Success Report', 'EW_updateSuccessReport')
      .addSeparator()
      .addSubMenu(ui.createMenu('Performance Analysis')
        .addItem('Top 20 Winning Plays', 'EW_showTopWinningPlays')
        .addItem('Multi-Day Profitability', 'EW_showMultiDayReport')
        .addItem('Strategy Performance', 'EW_showStrategyPerformance')
      )
      .addSubMenu(ui.createMenu('Indicator Analysis')
    ...
    .addSubMenu(ui.createMenu('⚙️ Automation')
      .addSubMenu(ui.createMenu('Setup Triggers')
        .addItem('Setup All Automation', 'EW_setupAutoTracking')
        .addItem('Setup Missing Only', 'EW_setupTriggersIfMissing')
        .addSeparator()
        .addItem('Daily Data (8AM)', 'EW_setupDailyDataTrigger')
        .addItem('Active Tracking (5PM)', 'EW_setupActiveTrackingTrigger')
      )
      .addSubMenu(ui.createMenu('Stop Triggers')
        .addItem('Stop All Automation', 'EW_stopAutoTracking')
        .addItem('Stop Daily Data', 'EW_stopDailyDataTrigger')
        .addItem('Stop Active Tracking', 'EW_removeActiveTrackingTrigger')
      )
      .addSeparator()
      .addSubMenu(ui.createMenu('Trigger Management')
        .addItem('List Active Triggers', 'EW_listActiveTriggers')
        .addItem('Validate Triggers', 'EW_validateTriggers')
        .addItem('Verify & Repair', 'EW_verifyAndRepairTriggers')
      )
      .addSeparator()
    ...
    .addSubMenu(ui.createMenu('🔧 Utilities')
      .addSubMenu(ui.createMenu('Formatting')
        .addItem('Format Current Sheet', 'EW_formatCurrentSheet')
        .addItem('Format All Sheets', 'EW_formatAllSheets')
      )
      .addSeparator()
      .addSubMenu(ui.createMenu('API Logging')
        .addItem('Check Missing (All)', 'EW_checkMissingApiLogs')
        .addItem('Check Missing (Selected)', 'EW_checkMissingLogsForSelected')
        .addSeparator()
        .addItem('View Today\'s Summary', 'EW_showApiSummary')
        .addItem('Create Daily Report', 'EW_createDailyApiReport')
