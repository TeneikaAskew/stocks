...
function onOpen() {
  ...
  ui.createMenu('EarningsWhispers')
    ...
    .addSeparator()
    .addItem('Rename Peak_Profit_Date to OHLC_Volume', 'EW_renamePeakProfitToOHLC')
    .addItem('Populate OHLC_Volume (All)', 'EW_populateOHLCVolume')
    ...
    .addItem('Apply Formatting (All Sheets)', 'EW_formatAllSheets')
    .addSeparator()
