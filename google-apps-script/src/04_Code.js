...
function onOpen() {
  ...
  ui.createMenu('EarningsWhispers')
    ...
    .addSeparator()
    .addItem('View Today\'s API Log Summary', 'EW_showApiSummary')
    .addItem('Create API Report', 'EW_createDailyApiReport')
    .addItem('Cleanup Old API Logs', 'EW_cleanupOldApiLogs')
