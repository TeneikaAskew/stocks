...
| [FEAT-PLAYBOOK-001](02-FEATURE-CATALOG.md#feat-playbook-001) | `platform/src/routes/PlaybookPage.tsx`, `platform/api/routers/playbook.py`, `gcp/premarket_brief.py`, `scripts/analysis/phase6_playbook.py` | `playbook.spec.ts`, `tests/scripts/test_phase6_playbook.py` | **Broken** |
...
| [FEAT-IND-001](02-FEATURE-CATALOG.md#feat-ind-001) | `lib/indicators.py`, `lib/signals.py` | `tests/lib/test_indicators*.py` | Production but needs remediation |
| [FEAT-INSIGHT-001](02-FEATURE-CATALOG.md#feat-insight-001) | `lib/agents/`, `platform/api/routers/insights.py`, `gcp/insight_pipeline_job.py` | `insights.spec.ts`, `tests/agents/test_agent_*.py` | Experimental |
...
| [FEAT-MODEL-001](02-FEATURE-CATALOG.md#feat-model-001) | `gcp/research/`, `lib/walk_forward.py`, `platform/api/routers/magnitude.py` | `tests/lib/test_walk_forward*.py`, `tests/*/test_magnitude*.py` | **Invalidated / Failed** (mixed) |
...
| [FEAT-ALERT-001](02-FEATURE-CATALOG.md#feat-alert-001) | `gcp/discord_interactions/main.py`, `gcp/failure_notifier.py` | `tests/gcp/test_notifier*.py` | Production but needs remediation |
...
| [FEAT-DATA-001](02-FEATURE-CATALOG.md#feat-data-001) | `gcp/fetchers/`, `gcp/schema.sql`, `lib/data_loader.py`, `gcp/database.py` | `tests/lib/test_data_loader*.py`, integration suite | Production but needs remediation |
...
| [FEAT-OPS-001](02-FEATURE-CATALOG.md#feat-ops-001) | `scripts/audit_data_freshness.py`, `gcp/failure_notifier.py`, `platform/api/routers/health.py` | `data-pipeline-status.spec.ts` deleted in #957 — see [#971](https://github.com/TeneikaAskew/stocks/issues/971) and [solyra#29](https://github.com/TeneikaAskew/solyra/pull/29) | Incomplete |
