...
|---|---|---|---|---|---|---|---|---|
| MODEL-MAG-001 | Magnitude prediction | ML | target magnitude class / probability | `gcp/research/magnitude_engine`, `platform/api/routers/magnitude.py` | **Experimental** | RETEST | **CONTRADICTED** · [DOC-06](#documentation-coverage-and-freshness) | Research arc closed **PROJECT VERDICT FAIL by gate 7** ([#575](https://github.com/TeneikaAskew/stocks/pull/575)). Later argmax-collapse incident: predicted TIGHT on 588/588 live bars; promotion gate added in [#810](https://github.com/TeneikaAskew/stocks/pull/810), no-op fixed in [#811](https://github.com/TeneikaAskew/stocks/pull/811). **2026-09-14 (E-26):** the serving `c49qf` artifacts measured as constants; the two promotion criteria were mutually unsatisfiable because they scored argmax. The contract now scores the consumer-visible threshold decision, and [#1117](https://github.com/TeneikaAskew/stocks/pull/1117) landed that correction. The amended criteria promoted `magnitude-engine-6hp7l` on SPY/QQQ/IWM 5m; IWM 15m still serves `c49qf`. Open: [#874](https://github.com/TeneikaAskew/stocks/issues/874), [#875](https://github.com/TeneikaAskew/stocks/issues/875), [#890](https://github.com/TeneikaAskew/stocks/issues/890) |
