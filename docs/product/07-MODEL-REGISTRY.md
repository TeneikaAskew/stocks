...
| DOC-24 | **FLAGGED — needs a code fix** | Documented in [MODEL-EARN-001](../models/MODEL-EARN-001.md); the divergence is in `gcp/refresh_earnings_views.py`, so correcting it belongs in a code PR, not this docs-only one |
