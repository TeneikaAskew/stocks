...
| `premarket-brief-daily` | `30 8 * * 1-5` | `premarket-brief` | MODEL-BRIEF-001 — and the MODEL-IND-001 / MODEL-STRAT-001 / MODEL-LEVEL-001 / mean-reversion condition helpers it imports at `gcp/premarket_brief.py:25-28`, plus MODEL-EARN-001 at `:615` |
...
published contract a reader would reasonably rely on. Ten of the 23 rows are bare `UNVERIFIED`
today.
...
| DOC-11 | [README](README.md) master matrix | Lists **15 of the 23** models in the two registry tables. Absent: **MODEL-BREAK-001, MODEL-DIR-001, MODEL-FEAT-X, MODEL-FLOW-001, MODEL-MAG-001, MODEL-NEXTBAR-001, MODEL-RANK-001, MODEL-TYPE-001**. *An earlier revision of this row said "every learned model is absent" and listed MODEL-SUM-001 — both wrong: MODEL-CALIB-001 and MODEL-STYLE-001 are learned and **are** present at README:138, MODEL-RANK-001 is heuristic not learned, and the actually-absent MODEL-FEAT-X was missing from the list. Recomputed from the tables rather than restated* | omission | **M** | (eight, listed) |
