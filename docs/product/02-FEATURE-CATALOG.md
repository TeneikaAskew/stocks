...
| [FEAT-SIGNAL-001](#feat-signal-001) | Signals / execution | Signal discovery, alerting, exits | `/signals`, `/live` | `/api/signals` | `signal_alerts`, `historical_signals`, `exit_config_overrides` | Production but needs remediation | P0 | 1 | 9 | [#816](https://github.com/TeneikaAskew/stocks/issues/816) [#815](https://github.com/TeneikaAskew/stocks/issues/815) [#928](https://github.com/TeneikaAskew/stocks/issues/928) [#905](https://github.com/TeneikaAskew/stocks/issues/905) |
...
| [FEAT-REPLAY-001](#feat-replay-001) | Replay / backtest engine | Point-in-time replay + evaluation | `/reports` | `/api/backtest/replay-trades` | `backtest_*`, `signal_alerts` | **Invalidated** | P0 | 2 | 22 | [#824](https://github.com/TeneikaAskew/stocks/issues/824) [#823](https://github.com/TeneikaAskew/stocks/issues/823) [#822](https://github.com/TeneikaAskew/stocks/issues/822) [#821](https://github.com/TeneikaAskew/stocks/issues/821) |
...
| Open issues | 7 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-auth-001--authentication) |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-waitlist-001--landing--waitlist) |
| Blocking issues | — |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-market-001--market-dashboard) |
| Blocking issues | — |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-live-001--intraday-monitoring) |
| Blocking issues | — |
| Next action | TBD — sequence from [13](13-ROADMAP.md) Phase 3 |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-chart-001--charting) |
| Blocking issues | — |
| Next action | TBD — sequence from [13](13-ROADMAP.md) Phase 5 |
...
| Open issues | 11 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-option-001--options--gamma) |
...
| Open issues | 9 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-signal-001--signals--execution) |
...
| Open issues | 1 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-playbook-001--premarket--playbook) |
...
| Open issues | 4 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-strat-001--strat--levels) |
...
| Open issues | 4 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-ind-001--indicators) |
...
| Open issues | 4 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-insight-001--ai-insights) |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-catalyst-001--earnings--catalysts) |
| Blocking issues | — |
| Next action | TBD — sequence from [13](13-ROADMAP.md) Phase 3 |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-report-001--reports--analytics) |
| Blocking issues | — |
...
| Open issues | 22 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-replay-001--replay--backtest-engine) |
...
| Open issues | 10 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-model-001--models--research) |
...
| Open issues | 3 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-journal-001--journal--portfolio) |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-alert-001--alerts--discord) |
| Blocking issues | — |
| Next action | TBD — sequence from [13](13-ROADMAP.md) Phase 3 |
...
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-admin-001--administration) |
| Blocking issues | — |
...
| Tests | `help.spec.ts` |
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-help-001--help--glossary) |
| Blocking issues | — |
| Next action | TBD — sequence from [13](13-ROADMAP.md) Phase 5 |
...
| Tests | **none** |
| Open issues | 0 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-settings-001--settings) |
| Blocking issues | — |
| Next action | TBD — sequence from [13](13-ROADMAP.md) Phase 5 |
...
| Open issues | 12 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-data-001--data-platform) |
...
| Open issues | 15 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-deploy-001--infrastructure--deploy) |
...
| Open issues | 3 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-ops-001--operations--reliability) |
...
| Open issues | 9 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-cicd-001--ci--testing) |
...
| Open issues | 2 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-ui-001--web--ui-shell) |
...
| Tests | — |
| Open issues | 3 — full list in [12](12-PR-ISSUE-TRACEABILITY.md#feat-debt-001--technical-debt) |
