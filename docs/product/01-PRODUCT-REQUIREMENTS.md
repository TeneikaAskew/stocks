...
| **REQ-RISK-001:** Risk-control calibration or activation SHALL use a production replay path proven to exercise the control and SHALL restore persisted session state before any default-no-op ceiling is lowered. | #818/#816/#940 | replay + trading-logic reviewers |
