...
| `backtest-pipeline` | `scripts/run_pipeline.py` | `backtest_reports`, `backtest_sweeps`, `backtest_trades`, `backtest_walk_forward_folds` | `scripts/calibrate_iwm_strat.py` |
...
flowchart LR
    ...
    J_backtest_pipeline ==> T_backtest_walk_forward_folds
