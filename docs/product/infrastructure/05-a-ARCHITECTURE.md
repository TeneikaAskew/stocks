...
|---|---|---|---|---|---|
| `apply-schema-migrations` | [`gcp/deploy.sh:3200`](../../../gcp/deploy.sh#L3200) | python -m gcp.apply_schema | 512Mi / 1 CPU / 1800s / retries 0 | main | 2026-09-07 ok |
| `audit-brief-bias` | [`gcp/deploy.sh:2489`](../../../gcp/deploy.sh#L2489) | python -m gcp.audit_job_runner | 1Gi / 1 CPU / 1800s / retries 0 | main | 2026-09-06 ok |
| `audit-infra-drift` | [`gcp/deploy.sh:2371`](../../../gcp/deploy.sh#L2371) | python -m gcp.audit_infra_drift | 512Mi / 1 CPU / 300s / retries 0 | main | 2026-09-06 ok |
| `audit-magnitude-drift` | [`gcp/deploy.sh:2409`](../../../gcp/deploy.sh#L2409) | python -m gcp.audit_magnitude_drift | 512Mi / 1 CPU / 180s / retries 0 | main | 2026-09-04 ok |
| `audit-walkforward` | [`gcp/deploy.sh:2451`](../../../gcp/deploy.sh#L2451) | python -m gcp.audit_job_runner | 1Gi / 1 CPU / 1800s / retries 0 | main | 2026-09-05 ok |
| `auto-refresh-top-n` | [`gcp/deploy.sh:813`](../../../gcp/deploy.sh#L813) | python -m gcp.auto_refresh_top_n | 1Gi / 1 CPU / 600s / retries 1 | main | 2026-09-04 ok |
| `backfill-daily-indicators` | [`gcp/deploy.sh:1969`](../../../gcp/deploy.sh#L1969) | python -m gcp.fetchers.backfill_daily_indicators | 2Gi / 2 CPU / 36000s / retries 0 | main | 2026-09-06 ok |
| `backfill-ticker` | [`gcp/deploy.sh:1096`](../../../gcp/deploy.sh#L1096) | python -m gcp.backfill_ticker | 1Gi / 1 CPU / 600s / retries 0 | main | 2026-05-04 ok |
| `backtest` | [`gcp/deploy.sh:1149`](../../../gcp/deploy.sh#L1149) | python -m gcp.backtest_job | 2Gi / 1 CPU / 900s / retries 1 | main | 2026-04-29 ok |
| `backtest-pipeline` | [`gcp/deploy.sh:2871`](../../../gcp/deploy.sh#L2871) | python -m scripts.run_pipeline | 8Gi / 2 CPU / 28800s / retries 0 | main | 2026-08-27 ok |
...
| `build-options-daily-features` | [`gcp/deploy.sh:1640`](../../../gcp/deploy.sh#L1640) | python -m gcp.fetchers.build_options_daily_features --incremental --days=7 | 4Gi / 2 CPU / 3600s / retries 0 | research | 2026-09-05 ok |
| `build-options-greeks` | [`gcp/deploy.sh:1603`](../../../gcp/deploy.sh#L1603) | python -m gcp.build_options_daily_greeks --incremental --days=7 | 4Gi / 2 CPU / 7200s / retries 0 | research | 2026-09-05 ok |
| `build-realtime-gex` | [`gcp/deploy.sh:1670`](../../../gcp/deploy.sh#L1670) | python -m gcp.build_realtime_gex --incremental --days=3 | 4Gi / 2 CPU / 1800s / retries 1 | research | 2026-09-04 ok |
| `calibrate-thresholds` | [`gcp/deploy.sh:3367`](../../../gcp/deploy.sh#L3367) | python -m scripts.calibrate_thresholds | 1Gi / 1 CPU / 600s / retries 1 | main | 2026-07-01 ok |
| `cloud-sql-weekly-export` | [`gcp/deploy.sh:3067`](../../../gcp/deploy.sh#L3067) | python -m gcp.sql_export_to_gcs | 512Mi / 1 CPU / 21600s / retries 0 | main | 2026-09-06 ok |
...
| `compute-earnings-reactions` | [`gcp/deploy.sh:2780`](../../../gcp/deploy.sh#L2780) | python -m gcp.fetchers.compute_earnings_reactions | 1Gi / 1 CPU / 1800s / retries 1 | main | 2026-09-06 ok |
| `compute-spx-greeks-backfill` | [`gcp/deploy.sh:3314`](../../../gcp/deploy.sh#L3314) | python -m scripts.maintenance.compute_spx_greeks --ticker SPX | 2Gi / 1 CPU / 43200s / retries 0 | main | **not deployed** |
| `db-query` | [`gcp/deploy.sh:2277`](../../../gcp/deploy.sh#L2277) | python -m gcp.db_query_job | 512Mi / 1 CPU / 600s / retries 0 | main | 2026-09-07 ok |
| `direction-baseline` | [`gcp/deploy.sh:1754`](../../../gcp/deploy.sh#L1754) | python -m gcp.research.direction_program.baseline_runner --tf=5m | 8Gi / 4 CPU / 10800s / retries 0 | research | 2026-07-08 ok |
| `direction-importance` | [`gcp/deploy.sh:1789`](../../../gcp/deploy.sh#L1789) | python -m gcp.research.direction_program.feature_importance --tf=5m | 8Gi / 4 CPU / 10800s / retries 0 | research | 2026-07-08 ok |
| `direction-phase2` | [`gcp/deploy.sh:1837`](../../../gcp/deploy.sh#L1837) | python -m gcp.research.direction_program.phase2_ablation | 8Gi / 4 CPU / 10800s / retries 0 / tasks ${n} | research | 2026-07-11 ok |
| `direction-probe` | [`gcp/deploy.sh:1564`](../../../gcp/deploy.sh#L1564) | python -m gcp.research.strat_engine.strat_dir_probes --experiment=e1_horizon --ticker=IWM --tf=15m --horizon=15 | 8Gi / 4 CPU / 5400s / retries 0 | research | 2026-06-21 ok |
| `earnings-long-watchlist` | [`gcp/deploy.sh:1245`](../../../gcp/deploy.sh#L1245) | python -m gcp.earnings_long_watchlist | 512Mi / 1 CPU / 600s / retries 0 | main | 2026-09-06 ok |
| `earnings-options-backfill` | [`gcp/deploy.sh:3563`](../../../gcp/deploy.sh#L3563) | python -m gcp.fetchers.fetch_av_earnings_options_backfill | 1Gi / 1 CPU / 32400s / retries 0 | main | 2026-05-22 ok |
| `earnings-reactions-brief` | [`gcp/deploy.sh:1212`](../../../gcp/deploy.sh#L1212) | python -m gcp.earnings_reactions_brief | 1Gi / 1 CPU / 600s / retries 0 | main | 2026-09-04 ok |
| `earnings-sweep` | [`gcp/deploy.sh:3433`](../../../gcp/deploy.sh#L3433) | python -m scripts.calibrate_earnings | 4Gi / 2 CPU / 1800s / retries 0 | main | 2026-05-22 ok |
| `etf-options-retention` | [`gcp/deploy.sh:2165`](../../../gcp/deploy.sh#L2165) | python -m gcp.options_retention_job | 512Mi / 1 CPU / 3600s / retries 0 | main | 2026-09-06 ok |
| `evaluate-ew-strikes` | [`gcp/deploy.sh:2608`](../../../gcp/deploy.sh#L2608) | python -m gcp.fetchers.evaluate_ew_strikes | 512Mi / 1 CPU / 600s / retries 1 | main | 2026-09-05 ok |
...
| `fetch-alphavantage-intraday` | [`gcp/deploy.sh:1993`](../../../gcp/deploy.sh#L1993) | python -m gcp.fetchers.fetch_alphavantage_intraday | 2Gi / 1 CPU / 3600s / retries 1 | main | 2026-09-06 ok |
| `fetch-av-options-backfill` | [`gcp/deploy.sh:2074`](../../../gcp/deploy.sh#L2074) | python -m gcp.fetchers.fetch_av_historical_options --tickers SPY IWM QQQ SPX --from-latest | 2Gi / 1 CPU / 43200s / retries 0 | main | 2026-09-05 ok |
| `fetch-av-options-realtime` | [`gcp/deploy.sh:2121`](../../../gcp/deploy.sh#L2121) | python -m gcp.fetchers.fetch_av_realtime_options --tickers SPY IWM QQQ | 512Mi / 1 CPU / 600s / retries 0 | main | 2026-09-04 ok |
| `fetch-earnings-calendar` | [`gcp/deploy.sh:2553`](../../../gcp/deploy.sh#L2553) | python scripts/fetch_earnings_calendar.py --source all --days 30 | 512Mi / 1 CPU / 1800s / retries 1 | main | 2026-09-06 ok |
| `fetch-earnings-history` | [`gcp/deploy.sh:2755`](../../../gcp/deploy.sh#L2755) | python -m gcp.fetchers.fetch_earnings_history | 1Gi / 1 CPU / 28800s / retries 1 | main | 2026-09-07 ok |
| `fetch-economic-events` | [`gcp/deploy.sh:2525`](../../../gcp/deploy.sh#L2525) | python -m gcp.fetchers.fetch_economic_events --source all | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-fred-rates` | [`gcp/deploy.sh:2500`](../../../gcp/deploy.sh#L2500) | python -m gcp.fetchers.fetch_fred_rates | 512Mi / 1 CPU / 600s / retries 1 | main | 2026-09-06 ok |
| `fetch-insider-transactions` | [`gcp/deploy.sh:2638`](../../../gcp/deploy.sh#L2638) | python -m gcp.fetchers.fetch_insider_transactions | 512Mi / 1 CPU / 1800s / retries 1 | main | 2026-09-04 ok |
| `fetch-market-data` | [`gcp/deploy.sh:1935`](../../../gcp/deploy.sh#L1935) | python -m gcp.fetchers.fetch_market_data | 1Gi / 1 CPU / 5400s / retries 2 | main | 2026-09-05 ok |
| `fetch-news-sentiment` | [`gcp/deploy.sh:2899`](../../../gcp/deploy.sh#L2899) | python -m gcp.fetchers.fetch_news_sentiment | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-news-sentiment-earnings` | [`gcp/deploy.sh:2926`](../../../gcp/deploy.sh#L2926) | python -m gcp.fetchers.fetch_news_sentiment | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-news-sentiment-topics` | [`gcp/deploy.sh:2957`](../../../gcp/deploy.sh#L2957) | python -m gcp.fetchers.fetch_news_sentiment | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-premarket-refresh` | [`gcp/deploy.sh:2581`](../../../gcp/deploy.sh#L2581) | python -m gcp.fetchers.fetch_premarket_refresh | 512Mi / 1 CPU / 300s / retries 1 | main | 2026-09-04 ok |
| `fetch-sec-filings` | [`gcp/deploy.sh:2704`](../../../gcp/deploy.sh#L2704) | python -m gcp.fetchers.fetch_sec_filings | 512Mi / 1 CPU / 1800s / retries 1 | main | 2026-09-04 ok |
| `fetch-top-movers` | [`gcp/deploy.sh:2676`](../../../gcp/deploy.sh#L2676) | python -m gcp.fetchers.fetch_top_movers | 512Mi / 1 CPU / 300s / retries 0 | main | 2026-09-04 ok |
| `freshness-watchdog` | [`gcp/deploy.sh:2331`](../../../gcp/deploy.sh#L2331) | python scripts/audit_data_freshness.py --strict | 512Mi / 1 CPU / 3600s / retries 0 | main | 2026-09-06 ok |
| `historical-signals-watchlist` | [`gcp/deploy.sh:584`](../../../gcp/deploy.sh#L584) | python -m scripts.run_historical_signals --from-watchlist | 2Gi / 1 CPU / 1800s / retries 1 | main | 2026-09-05 ok |
| `indicator-correlation` | [`gcp/deploy.sh:718`](../../../gcp/deploy.sh#L718) | python -m gcp.indicator_correlation_job | 1Gi / 1 CPU / 1800s / retries 1 | research | 2026-05-31 ok |
| `insight-discord-push` | [`gcp/deploy.sh:549`](../../../gcp/deploy.sh#L549) | python -m gcp.insight_discord_push | 512Mi / 1 CPU / 120s / retries 1 | main | 2026-09-04 ok |
| `insight-pipeline` | [`gcp/deploy.sh:525`](../../../gcp/deploy.sh#L525) | python -m gcp.insight_pipeline_job | 2Gi / 1 CPU / 1800s / retries 1 | main | 2026-09-04 ok |
| `intraday-bulk-backfill` | [`gcp/deploy.sh:3533`](../../../gcp/deploy.sh#L3533) | python -m gcp.fetchers.fetch_alphavantage_intraday --symbols-file /app/gcp/fetchers/symbol_lists/earnings_universe.txt --start-date 2024-01-01 | 1Gi / 1 CPU / 86400s / retries 0 / tasks 4 | main | 2026-05-23 failed |
| `magnitude-engine` | [`gcp/deploy.sh:1713`](../../../gcp/deploy.sh#L1713) | python -m gcp.research.magnitude_engine.mag_walk_forward | 8Gi / 4 CPU / 5400s / retries 0 / tasks ${plan_size} | research | 2026-08-27 ok |
| `magnitude-inference` | [`gcp/deploy.sh:1875`](../../../gcp/deploy.sh#L1875) | python -m gcp.research.magnitude_engine.mag_inference | 1Gi / 1 CPU / 300s / retries 0 | research | 2026-09-04 ok |
| `magnitude-recal` | [`gcp/deploy.sh:1830`](../../../gcp/deploy.sh#L1830) | python -m gcp.research.magnitude_engine.mag_walk_forward --phase=phase0 --all-cells --calibration=isotonic | 8Gi / 4 CPU / 10800s / retries 0 | research | 2026-07-12 ok |
| `options-exec-backtest` | [`gcp/deploy.sh:2232`](../../../gcp/deploy.sh#L2232) | python -m lib.options_exec_backtest.cli --mode=base | 8Gi / 2 CPU / 14400s / retries 0 | research | **not deployed** |
| `p2-build-gamma-levels` | [`gcp/deploy.sh:1429`](../../../gcp/deploy.sh#L1429) | python -m gcp.research.p2_build_gamma_levels | 2Gi / 2 CPU / 5400s / retries 0 | research | 2026-09-05 ok |
...
| `param-sweep` | [`gcp/deploy.sh:3400`](../../../gcp/deploy.sh#L3400) | python -m scripts.run_param_sweep | 4Gi / 1 CPU / 21600s / retries 0 / tasks 3 | main | 2026-05-20 ok |
| `phase6-playbook` | [`gcp/deploy.sh:1386`](../../../gcp/deploy.sh#L1386) | python -m scripts.analysis.phase6_playbook --write-db | 16Gi / 4 CPU / 3600s / retries 0 / tasks 3 | main | 2026-09-06 ok |
| `premarket-brief` | [`gcp/deploy.sh:1182`](../../../gcp/deploy.sh#L1182) | python -m gcp.premarket_brief | 1Gi / 1 CPU / 1800s / retries 0 | main | 2026-09-07 ok |
| `premarket-playbook-resolver` | [`gcp/deploy.sh:1334`](../../../gcp/deploy.sh#L1334) | python -m gcp.premarket_playbook_resolver | 1Gi / 1 CPU / 3600s / retries 0 | main | 2026-09-05 ok |
| `refresh-earnings-views` | [`gcp/deploy.sh:2814`](../../../gcp/deploy.sh#L2814) | python -m gcp.refresh_earnings_views --mode=weekly | 1Gi / 1 CPU / 1200s / retries 0 | main | 2026-09-07 ok |
| `regime-combo` | [`gcp/deploy.sh:755`](../../../gcp/deploy.sh#L755) | python -m gcp.regime_combo_job | 2Gi / 2 CPU / 3600s / retries 1 | research | 2026-09-06 ok |
| `signal-monitor` | [`gcp/deploy.sh:1267`](../../../gcp/deploy.sh#L1267) | python -m gcp.signal_monitor | 2Gi / 1 CPU / 28800s / retries 0 | main | 2026-09-04 ok |
| `signal-monitor-eod-resolver` | [`gcp/deploy.sh:1301`](../../../gcp/deploy.sh#L1301) | python -m gcp.signal_monitor_eod_resolver | 1Gi / 1 CPU / 3600s / retries 0 | main | 2026-09-04 ok |
| `signal-quality-alarm` | [`gcp/deploy.sh:678`](../../../gcp/deploy.sh#L678) | python -m gcp.signal_quality_alarm | 512Mi / 1 CPU / 120s / retries 0 | main | 2026-09-05 ok |
| `signal-quality-report` | [`gcp/deploy.sh:637`](../../../gcp/deploy.sh#L637) | python -m scripts.signal_quality_report --mode=rolling | 1Gi / 1 CPU / 3600s / retries 0 | main | 2026-09-05 ok |
| `signal-replay` | [`gcp/deploy.sh:784`](../../../gcp/deploy.sh#L784) | python -m gcp.signal_replay | 512Mi / 1 CPU / 900s / retries 0 | main | 2026-05-17 ok |
...
| `strat-engine` | [`gcp/deploy.sh:1524`](../../../gcp/deploy.sh#L1524) | python -m gcp.research.strat_engine.strat_data_builder | 16Gi / 4 CPU / 5400s / retries 0 | research | 2026-09-05 ok |
| `validate-brief` | [`gcp/deploy.sh:1123`](../../../gcp/deploy.sh#L1123) | python -m gcp.validate_brief_job | 1Gi / 1 CPU / 300s / retries 1 | main | 2026-04-29 ok |
| `weekend-review` | [`gcp/deploy.sh:1907`](../../../gcp/deploy.sh#L1907) | python -m gcp.weekend_review | 1Gi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-05 ok |
<!-- inventory:jobs:end -->
