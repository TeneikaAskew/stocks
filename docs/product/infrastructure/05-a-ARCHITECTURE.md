...
3. **No DDL in the repository at all** — the `*_30m_predictions` tables, whose only writer (`gcp/research/_archive/p7a_iwm_30m_pipeline.py`) is archived. They are live residue of a retired pipeline.
