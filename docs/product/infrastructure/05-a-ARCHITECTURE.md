...
|---|---|---|---|---|---|
| `apply-schema-migrations` | [`gcp/deploy.sh:3318`](../../../gcp/deploy.sh#L3318) | python -m gcp.apply_schema | 512Mi / 1 CPU / 1800s / retries 0 | main | 2026-09-07 ok |
| `audit-brief-bias` | [`gcp/deploy.sh:2607`](../../../gcp/deploy.sh#L2607) | python -m gcp.audit_job_runner | 1Gi / 1 CPU / 1800s / retries 0 | main | 2026-09-06 ok |
| `audit-infra-drift` | [`gcp/deploy.sh:2489`](../../../gcp/deploy.sh#L2489) | python -m gcp.audit_infra_drift | 512Mi / 1 CPU / 300s / retries 0 | main | 2026-09-06 ok |
| `audit-magnitude-drift` | [`gcp/deploy.sh:2527`](../../../gcp/deploy.sh#L2527) | python -m gcp.audit_magnitude_drift | 512Mi / 1 CPU / 180s / retries 0 | main | 2026-09-04 ok |
| `audit-walkforward` | [`gcp/deploy.sh:2569`](../../../gcp/deploy.sh#L2569) | python -m gcp.audit_job_runner | 1Gi / 1 CPU / 1800s / retries 0 | main | 2026-09-05 ok |
...
| `backfill-daily-indicators` | [`gcp/deploy.sh:2087`](../../../gcp/deploy.sh#L2087) | python -m gcp.fetchers.backfill_daily_indicators | 2Gi / 2 CPU / 36000s / retries 0 | main | 2026-09-06 ok |
| `backfill-ticker` | [`gcp/deploy.sh:1199`](../../../gcp/deploy.sh#L1199) | python -m gcp.backfill_ticker | 1Gi / 1 CPU / 600s / retries 0 | main | 2026-05-04 ok |
| `backtest` | [`gcp/deploy.sh:1252`](../../../gcp/deploy.sh#L1252) | python -m gcp.backtest_job | 2Gi / 1 CPU / 900s / retries 1 | main | 2026-04-29 ok |
| `backtest-pipeline` | [`gcp/deploy.sh:2989`](../../../gcp/deploy.sh#L2989) | python -m scripts.run_pipeline | 8Gi / 2 CPU / 28800s / retries 0 | main | 2026-08-27 ok |
...
| `build-options-daily-features` | [`gcp/deploy.sh:1749`](../../../gcp/deploy.sh#L1749) | python -m gcp.fetchers.build_options_daily_features --incremental --days=7 | 4Gi / 2 CPU / 3600s / retries 0 | research | 2026-09-05 ok |
| `build-options-greeks` | [`gcp/deploy.sh:1712`](../../../gcp/deploy.sh#L1712) | python -m gcp.build_options_daily_greeks --incremental --days=7 | 4Gi / 2 CPU / 7200s / retries 0 | research | 2026-09-05 ok |
| `build-realtime-gex` | [`gcp/deploy.sh:1779`](../../../gcp/deploy.sh#L1779) | python -m gcp.build_realtime_gex --incremental --days=3 | 4Gi / 2 CPU / 1800s / retries 1 | research | 2026-09-04 ok |
| `calibrate-thresholds` | [`gcp/deploy.sh:3485`](../../../gcp/deploy.sh#L3485) | python -m scripts.calibrate_thresholds | 1Gi / 1 CPU / 600s / retries 1 | main | 2026-07-01 ok |
| `cloud-sql-weekly-export` | [`gcp/deploy.sh:3185`](../../../gcp/deploy.sh#L3185) | python -m gcp.sql_export_to_gcs | 512Mi / 1 CPU / 21600s / retries 0 | main | 2026-09-06 ok |
...
| `compute-earnings-reactions` | [`gcp/deploy.sh:2898`](../../../gcp/deploy.sh#L2898) | python -m gcp.fetchers.compute_earnings_reactions | 1Gi / 1 CPU / 1800s / retries 1 | main | 2026-09-06 ok |
| `compute-spx-greeks-backfill` | [`gcp/deploy.sh:3432`](../../../gcp/deploy.sh#L3432) | python -m scripts.maintenance.compute_spx_greeks --ticker SPX | 2Gi / 1 CPU / 43200s / retries 0 | main | **not deployed** |
| `db-query` | [`gcp/deploy.sh:2395`](../../../gcp/deploy.sh#L2395) | python -m gcp.db_query_job | 512Mi / 1 CPU / 600s / retries 0 | main | 2026-09-07 ok |
| `direction-baseline` | [`gcp/deploy.sh:1872`](../../../gcp/deploy.sh#L1872) | python -m gcp.research.direction_program.baseline_runner --tf=5m | 8Gi / 4 CPU / 10800s / retries 0 | research | 2026-07-08 ok |
| `direction-importance` | [`gcp/deploy.sh:1907`](../../../gcp/deploy.sh#L1907) | python -m gcp.research.direction_program.feature_importance --tf=5m | 8Gi / 4 CPU / 10800s / retries 0 | research | 2026-07-08 ok |
| `direction-phase2` | [`gcp/deploy.sh:1955`](../../../gcp/deploy.sh#L1955) | python -m gcp.research.direction_program.phase2_ablation | 8Gi / 4 CPU / 10800s / retries 0 / tasks ${n} | research | 2026-07-11 ok |
| `direction-probe` | [`gcp/deploy.sh:1673`](../../../gcp/deploy.sh#L1673) | python -m gcp.research.strat_engine.strat_dir_probes --experiment=e1_horizon --ticker=IWM --tf=15m --horizon=15 | 8Gi / 4 CPU / 5400s / retries 0 | research | 2026-06-21 ok |
| `earnings-long-watchlist` | [`gcp/deploy.sh:1348`](../../../gcp/deploy.sh#L1348) | python -m gcp.earnings_long_watchlist | 512Mi / 1 CPU / 600s / retries 0 | main | 2026-09-06 ok |
| `earnings-options-backfill` | [`gcp/deploy.sh:3681`](../../../gcp/deploy.sh#L3681) | python -m gcp.fetchers.fetch_av_earnings_options_backfill | 1Gi / 1 CPU / 32400s / retries 0 | main | 2026-05-22 ok |
| `earnings-reactions-brief` | [`gcp/deploy.sh:1315`](../../../gcp/deploy.sh#L1315) | python -m gcp.earnings_reactions_brief | 1Gi / 1 CPU / 600s / retries 0 | main | 2026-09-04 ok |
| `earnings-sweep` | [`gcp/deploy.sh:3551`](../../../gcp/deploy.sh#L3551) | python -m scripts.calibrate_earnings | 4Gi / 2 CPU / 1800s / retries 0 | main | 2026-05-22 ok |
| `etf-options-retention` | [`gcp/deploy.sh:2283`](../../../gcp/deploy.sh#L2283) | python -m gcp.options_retention_job | 512Mi / 1 CPU / 3600s / retries 0 | main | 2026-09-06 ok |
| `evaluate-ew-strikes` | [`gcp/deploy.sh:2726`](../../../gcp/deploy.sh#L2726) | python -m gcp.fetchers.evaluate_ew_strikes | 512Mi / 1 CPU / 600s / retries 1 | main | 2026-09-05 ok |
...
| `fetch-alphavantage-intraday` | [`gcp/deploy.sh:2111`](../../../gcp/deploy.sh#L2111) | python -m gcp.fetchers.fetch_alphavantage_intraday | 2Gi / 1 CPU / 3600s / retries 1 | main | 2026-09-06 ok |
| `fetch-av-options-backfill` | [`gcp/deploy.sh:2192`](../../../gcp/deploy.sh#L2192) | python -m gcp.fetchers.fetch_av_historical_options --tickers SPY IWM QQQ SPX --from-latest | 2Gi / 1 CPU / 43200s / retries 0 | main | 2026-09-05 ok |
| `fetch-av-options-realtime` | [`gcp/deploy.sh:2239`](../../../gcp/deploy.sh#L2239) | python -m gcp.fetchers.fetch_av_realtime_options --tickers SPY IWM QQQ | 512Mi / 1 CPU / 600s / retries 0 | main | 2026-09-04 ok |
| `fetch-earnings-calendar` | [`gcp/deploy.sh:2671`](../../../gcp/deploy.sh#L2671) | python scripts/fetch_earnings_calendar.py --source all --days 30 | 512Mi / 1 CPU / 1800s / retries 1 | main | 2026-09-06 ok |
| `fetch-earnings-history` | [`gcp/deploy.sh:2873`](../../../gcp/deploy.sh#L2873) | python -m gcp.fetchers.fetch_earnings_history | 1Gi / 1 CPU / 28800s / retries 1 | main | 2026-09-07 ok |
| `fetch-economic-events` | [`gcp/deploy.sh:2643`](../../../gcp/deploy.sh#L2643) | python -m gcp.fetchers.fetch_economic_events --source all | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-fred-rates` | [`gcp/deploy.sh:2618`](../../../gcp/deploy.sh#L2618) | python -m gcp.fetchers.fetch_fred_rates | 512Mi / 1 CPU / 600s / retries 1 | main | 2026-09-06 ok |
| `fetch-insider-transactions` | [`gcp/deploy.sh:2756`](../../../gcp/deploy.sh#L2756) | python -m gcp.fetchers.fetch_insider_transactions | 512Mi / 1 CPU / 1800s / retries 1 | main | 2026-09-04 ok |
| `fetch-market-data` | [`gcp/deploy.sh:2053`](../../../gcp/deploy.sh#L2053) | python -m gcp.fetchers.fetch_market_data | 1Gi / 1 CPU / 5400s / retries 2 | main | 2026-09-05 ok |
| `fetch-news-sentiment` | [`gcp/deploy.sh:3017`](../../../gcp/deploy.sh#L3017) | python -m gcp.fetchers.fetch_news_sentiment | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-news-sentiment-earnings` | [`gcp/deploy.sh:3044`](../../../gcp/deploy.sh#L3044) | python -m gcp.fetchers.fetch_news_sentiment | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-news-sentiment-topics` | [`gcp/deploy.sh:3075`](../../../gcp/deploy.sh#L3075) | python -m gcp.fetchers.fetch_news_sentiment | 512Mi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-04 ok |
| `fetch-premarket-refresh` | [`gcp/deploy.sh:2699`](../../../gcp/deploy.sh#L2699) | python -m gcp.fetchers.fetch_premarket_refresh | 512Mi / 1 CPU / 300s / retries 1 | main | 2026-09-04 ok |
| `fetch-sec-filings` | [`gcp/deploy.sh:2822`](../../../gcp/deploy.sh#L2822) | python -m gcp.fetchers.fetch_sec_filings | 512Mi / 1 CPU / 1800s / retries 1 | main | 2026-09-04 ok |
| `fetch-top-movers` | [`gcp/deploy.sh:2794`](../../../gcp/deploy.sh#L2794) | python -m gcp.fetchers.fetch_top_movers | 512Mi / 1 CPU / 300s / retries 0 | main | 2026-09-04 ok |
| `freshness-watchdog` | [`gcp/deploy.sh:2449`](../../../gcp/deploy.sh#L2449) | python scripts/audit_data_freshness.py --strict | 512Mi / 1 CPU / 3600s / retries 0 | main | 2026-09-06 ok |
...
| `intraday-bulk-backfill` | [`gcp/deploy.sh:3651`](../../../gcp/deploy.sh#L3651) | python -m gcp.fetchers.fetch_alphavantage_intraday --symbols-file /app/gcp/fetchers/symbol_lists/earnings_universe.txt --start-date 2024-01-01 | 1Gi / 1 CPU / 86400s / retries 0 / tasks 4 | main | 2026-05-23 failed |
| `magnitude-engine` | [`gcp/deploy.sh:1831`](../../../gcp/deploy.sh#L1831) | python -m gcp.research.magnitude_engine.mag_walk_forward | 8Gi / 4 CPU / 5400s / retries 0 / tasks ${plan_size} | research | 2026-08-27 ok |
| `magnitude-inference` | [`gcp/deploy.sh:1993`](../../../gcp/deploy.sh#L1993) | python -m gcp.research.magnitude_engine.mag_inference | 1Gi / 1 CPU / 300s / retries 0 | research | 2026-09-04 ok |
| `magnitude-recal` | [`gcp/deploy.sh:1948`](../../../gcp/deploy.sh#L1948) | python -m gcp.research.magnitude_engine.mag_walk_forward --phase=phase0 --all-cells --calibration=isotonic | 8Gi / 4 CPU / 10800s / retries 0 | research | 2026-07-12 ok |
| `options-exec-backtest` | [`gcp/deploy.sh:2350`](../../../gcp/deploy.sh#L2350) | python -m lib.options_exec_backtest.cli --mode=base | 8Gi / 2 CPU / 14400s / retries 0 | research | **not deployed** |
| `p2-build-gamma-levels` | [`gcp/deploy.sh:1538`](../../../gcp/deploy.sh#L1538) | python -m gcp.research.p2_build_gamma_levels | 2Gi / 2 CPU / 5400s / retries 0 | research | 2026-09-05 ok |
...
| `param-sweep` | [`gcp/deploy.sh:3518`](../../../gcp/deploy.sh#L3518) | python -m scripts.run_param_sweep | 4Gi / 1 CPU / 21600s / retries 0 / tasks 3 | main | 2026-05-20 ok |
| `phase6-playbook` | [`gcp/deploy.sh:1489`](../../../gcp/deploy.sh#L1489) | python -m scripts.analysis.phase6_playbook --write-db | 16Gi / 4 CPU / 3600s / retries 0 / tasks 3 | main | 2026-09-06 ok |
| `premarket-brief` | [`gcp/deploy.sh:1285`](../../../gcp/deploy.sh#L1285) | python -m gcp.premarket_brief | 1Gi / 1 CPU / 1800s / retries 0 | main | 2026-09-07 ok |
| `premarket-playbook-resolver` | [`gcp/deploy.sh:1437`](../../../gcp/deploy.sh#L1437) | python -m gcp.premarket_playbook_resolver | 1Gi / 1 CPU / 3600s / retries 0 | main | 2026-09-05 ok |
| `refresh-earnings-views` | [`gcp/deploy.sh:2932`](../../../gcp/deploy.sh#L2932) | python -m gcp.refresh_earnings_views --mode=weekly | 1Gi / 1 CPU / 1200s / retries 0 | main | 2026-09-07 ok |
...
| `signal-monitor` | [`gcp/deploy.sh:1370`](../../../gcp/deploy.sh#L1370) | python -m gcp.signal_monitor | 2Gi / 1 CPU / 28800s / retries 0 | main | 2026-09-04 ok |
| `signal-monitor-eod-resolver` | [`gcp/deploy.sh:1404`](../../../gcp/deploy.sh#L1404) | python -m gcp.signal_monitor_eod_resolver | 1Gi / 1 CPU / 3600s / retries 0 | main | 2026-09-04 ok |
...
| `strat-engine` | [`gcp/deploy.sh:1633`](../../../gcp/deploy.sh#L1633) | python -m gcp.research.strat_engine.strat_data_builder | 16Gi / 4 CPU / 5400s / retries 0 | research | 2026-09-05 ok |
| `validate-brief` | [`gcp/deploy.sh:1226`](../../../gcp/deploy.sh#L1226) | python -m gcp.validate_brief_job | 1Gi / 1 CPU / 300s / retries 1 | main | 2026-04-29 ok |
| `weekend-review` | [`gcp/deploy.sh:2025`](../../../gcp/deploy.sh#L2025) | python -m gcp.weekend_review | 1Gi / 1 CPU / 600s / retries 1 (defaults) | main | 2026-09-05 ok |
<!-- inventory:jobs:end -->
