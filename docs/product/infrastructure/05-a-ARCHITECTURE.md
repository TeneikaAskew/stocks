...
| `GET` | `/api/magnitude/{ticker}/{tf}/at/{ts}` | [`platform/api/routers/magnitude.py:174`](../../../platform/api/routers/magnitude.py#L174) | Return the prediction for exactly this (ticker, tf, ts). |
| `GET` | `/api/magnitude/{ticker}/{tf}/latest` | [`platform/api/routers/magnitude.py:125`](../../../platform/api/routers/magnitude.py#L125) | Return the most-recent prediction for this (ticker, tf). |
