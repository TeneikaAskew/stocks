...
| `POST` | `/api/insights/chat` | [`platform/api/routers/insights.py:1103`](../../../platform/api/routers/insights.py#L1103) | Stream a Gemini response for the given mode and message. |
| `GET` | `/api/insights/report/{ticker}` | [`platform/api/routers/insights.py:753`](../../../platform/api/routers/insights.py#L753) | Return the most recent InsightReport for the ticker. |
| `GET` | `/api/insights/report/{ticker}/history` | [`platform/api/routers/insights.py:782`](../../../platform/api/routers/insights.py#L782) | Return a scannable list of recent reports for the ticker. |
| `POST` | `/api/insights/report/{ticker}/refresh` | [`platform/api/routers/insights.py:830`](../../../platform/api/routers/insights.py#L830) | Enqueue a fresh pipeline run for the ticker. |
| `GET` | `/api/insights/reports/{report_id}` | [`platform/api/routers/insights.py:792`](../../../platform/api/routers/insights.py#L792) | Return a single insight report by row id. |
| `GET` | `/api/insights/runs/{run_id}` | [`platform/api/routers/insights.py:954`](../../../platform/api/routers/insights.py#L954) | Poll the status of a refresh run. |
| `GET` | `/api/insights/ticker/search` | [`platform/api/routers/insights.py:533`](../../../platform/api/routers/insights.py#L533) | Search for tickers by keyword (company name, symbol, etc). |
| `GET` | `/api/insights/ticker/{ticker}/info` | [`platform/api/routers/insights.py:548`](../../../platform/api/routers/insights.py#L548) | Return cached ticker details (AV OVERVIEW), fetching if needed. |
| `GET` | `/api/insights/ticker/{ticker}/peers` | [`platform/api/routers/insights.py:579`](../../../platform/api/routers/insights.py#L579) | Return peer tickers from FinViz (cached). |
| `GET` | `/api/insights/ticker/{ticker}/quote` | [`platform/api/routers/insights.py:568`](../../../platform/api/routers/insights.py#L568) | Return latest price/volume from AV GLOBAL_QUOTE. |
| `GET` | `/api/insights/watchlist` | [`platform/api/routers/insights.py:698`](../../../platform/api/routers/insights.py#L698) | Return today's ranked candidate tickers with score breakdowns. |
| `POST` | `/api/insights/watchlist/add` | [`platform/api/routers/insights.py:588`](../../../platform/api/routers/insights.py#L588) | Add a ticker to the watchlist and return its info + quote. |
| `DELETE` | `/api/insights/watchlist/{ticker}` | [`platform/api/routers/insights.py:665`](../../../platform/api/routers/insights.py#L665) | Soft-delete a ticker from the watchlist (sets removed_at=NOW()). |
