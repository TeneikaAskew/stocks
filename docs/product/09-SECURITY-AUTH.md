...
**Last reviewed:** 2026-09-04 · **Last scanned:** 2026-09-16 · **Owner:** TBD · **Trust status:** Production but needs remediation
...
1. **Six project-level viewer roles** were granted by the operator for the
   ...
   `docs/product/infrastructure/05-a-ARCHITECTURE.md` §1).
