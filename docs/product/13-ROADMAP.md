...
**Last reviewed:** 2026-09-14 · Dates, releases and owners are **TBD**. Status is planning
...
| **2** | Replay & evaluation trust | FEAT-REPLAY-001, FEAT-REPORT-001 | Phase 1 clock and provenance | In progress — the **provenance half is done** (#820, #1095: every API-served table now labels replay/backfill rows and the live surfaces filter them); the **as-of-leakage half is not** | [#824](https://github.com/TeneikaAskew/stocks/issues/824) [#823](https://github.com/TeneikaAskew/stocks/issues/823) [#822](https://github.com/TeneikaAskew/stocks/issues/822) [#821](https://github.com/TeneikaAskew/stocks/issues/821) [#820](https://github.com/TeneikaAskew/stocks/issues/820) [#819](https://github.com/TeneikaAskew/stocks/issues/819) | Point-in-time-safe replay; leaked artifacts quarantined and rerun; live/replay parity fixtures pass |
...
| ~~[#820](https://github.com/TeneikaAskew/stocks/issues/820)~~ | CRITICAL | ~~[audit] R3 — scripts/backfill_signals.py silently scores zero, into production signal_alerts~~ — **DONE 2026-09-14**: script deleted, 844 simulated rows marked `run_kind='backfill'` |
| ~~[#1095](https://github.com/TeneikaAskew/stocks/issues/1095)~~ | CRITICAL | ~~Provenance sweep — three more API-served tables could not distinguish backfill from live~~ — **DONE 2026-09-14** via [#1098](https://github.com/TeneikaAskew/stocks/pull/1098); 1,553,629 + 86 + 135 rows labelled, writer/reader guards in CI |
...
6. Stop training from auto-writing production — [#813](https://github.com/TeneikaAskew/stocks/issues/813), [#817](https://github.com/TeneikaAskew/stocks/issues/817) — 2026-09-14: the magnitude promotion criteria were measured mutually unsatisfiable (argmax-scored) and replaced with a decision-rule verdict; the sweep that established it promoted nothing (E-35). The serving cells' fate is an open decision in [15](15-OPEN-DECISIONS.md)
