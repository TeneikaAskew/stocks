...
4. Done in the follow-up: `.github/workflows/README.md` describes the five live workflow files and the two retired ones instead of the 2025 market-data fetcher; the indicator and storage prose it carried lives in `lib/` docstrings and ARCHITECTURE.md.
