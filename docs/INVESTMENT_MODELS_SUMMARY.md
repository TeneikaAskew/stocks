...
- **Part A — Investment Models & Code Summary** (was `INVESTMENT_MODELS_SUMMARY.md`)
- **Part B — Investment Models Summary** (was `docs/MODEL_SUMMARY.md`)

---

# PART A — Investment Models & Code Summary
...
# PART B — Investment Models Summary
