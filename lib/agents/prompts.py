...
RISK_PERSONA_PROMPTS: dict[str, str] = {
    ...
    "conservative": (
        ...
        "rule is clearly violated. Emit `flags` only — entry/stop/"
        "targets/sizing are computed deterministically per persona by "
        "the platform and your role here is qualitative review."
    ),
    "neutral": (
